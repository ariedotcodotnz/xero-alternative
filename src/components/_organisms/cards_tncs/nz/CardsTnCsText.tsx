...
const CardsTnCsTextNz = () => (
  <div className="tw-prose tw-prose-sm tw-prose-gray !tw-max-w-full">
    ...
    <dl>
      ...
      <div className="tw-mb-4">
        <dt className="tw-inline">Card Issuer</dt>&nbsp;
        <dd className="tw-inline">
          means Flexewallet Pty Ltd (ABN:16164657032) pursuant to a licence
          by Visa WorldWide Pte Ltd.
        </dd>
      </div>
      <div className="tw-mb-4">
        <dt className="tw-inline">VISA Digital Debit Card (&ldquo;Card&rdquo;)</dt>&nbsp;
        <dd className="tw-inline">
          means the Hnry&rsquo;s VISA Debit Card.
        </dd>
      </div>
      <div className="tw-mb-4">
    ...
    <p>
      These are the terms and conditions (T&amp;Cs) on which Hnry Limited (Hnry)
      NZ Company number 6251417 provides the Digital Debit Card (Card) to you.
    </p>
    <p>
    ...
    <p>
      We are not responsible for transactions that are processed as a
      result of an indirect or direct breach of these Terms and Conditions.
    </p>
    <h3 className="hnry-heading hnry-heading--h3">General Terms</h3>
    <p>
      These Terms and Conditions are an agreement between you and Hnry that
      governs your access to and use of your Card through an eligible Digital
      Wallet Service. The term Digital Wallet Service includes the relevant
      branded Digital Wallet Service&rsquo;s payment functionality provided
      by Apple and Google, the Card provisioning functionality, and display
    ...
    <ol>
      <li>
        ...
        <ol type="a">
          ...
          <li>
            ...
            use your Card to make such purchases in place of presenting or
      ...
      <li>
        ...
        financial institutions to withdraw cash.
      </li>
      <li>
      ...
      <li>
        ...
        <ol type="a">
          <li>
            may breach any laws or regulations in New Zealand or in any other
            country;
          </li>
          <li>
    ...
    <ol>
      <li>
        Use and access to the card is subject to your respective device, which must
      ...
      <li>
        ...
        use your Card through that Digital Wallet Service in accordance with these
    ...
    <ol>
      <li>
        ...
        on your device by accessing the Hnry App or the Hnry website.
      </li>
      <li>
      ...
      <li>
        The Card can be topped up via bank transfer from your personal bank
        account linked to your Hnry account or through the allocation feature on
        your Hnry App or Hnry website.
      </li>
    </ol>
    ...
    <ol>
      <li>
        ...
        <ol type="a">
          <li>
            ...
            for any transactions initiated by that person with the card; or
          </li>
          <li>
      ...
      <li>
        Please contact us on +64 4 4881761 (9:00am to 5:00pm Monday to Friday)
        if:
        <ol type="a">
          <li>
          ...
          <li>
            Your Device and/or your Card added to Digital Wallet Service
            has been subject to unauthorised use or access ; or -
          </li>
          <li>
    ...
    <ol>
      <li>
        We currently do not impose a fee for using your Card through a Digital
        Wallet Service but we reserve the right to impose a fee at our
    ...
    <ol>
      ...
      <li>
        ...
        contact us on +64 4 4881761 (9:00am to 5:00pm Monday to Friday)
      </li>
    </ol>
      ...
      <li>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <th>Card Spend per day</th>
              <td>9,900 NZD</td>
            </tr>
            <tr>
              <th>Single Card Transaction</th>
              <td>9,900 NZD</td>
            </tr>
          </tbody>
        </table>
...
export default CardsTnCsTextNz;
